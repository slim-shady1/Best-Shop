                        ...
                        <form className="needs-validation" novalidate="">
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="firstName" placeholder="Your firstname:" value="" required="" />
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="lastName" placeholder="Your last name:" value="" required="" />
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="text" className="form-control" id="address" placeholder="2156 Street St" required="" />
                                    <div className="invalid-feedback">
